...
C:\p\1ziptar\7-Zip\7z.exe a -y -t7z  -xr!templates_c -xr!nbproject -xr!.git -xr!.svn -xr!.hg "c:\backup\dgnote130\dgnote130.xata.%dhms%.%computername%.7z" C:\p2\xampp\htdocs\dgnote130 
