...
:copy "c:\backup\dgnote130\dgnote130.xata.%dhms%.%computername%.7z" "C:\n\Dropbox\csd\copyof\dgnote130,tagger"

robocopy C:\p2\xampp\htdocs\dgnote130 C:\n\Dropbox\csd\crepo\dgnote130\%computername%  /l  /e /xd templates_c\ nbproject /fft /dst /xo /ndl /np /r:0 /w:0 /tee /eta /log:"c:rb-130cn-%computername%,%dhms%"

:get master
robocopy C:\n\Dropbox\csd\crepo\dgnote130\master  C:\p2\xampp\htdocs\dgnote130 /l  /e  /xd templates_c\ nbproject /fft /dst /xo /ndl /np /r:0 /w:0 /tee /eta /log:"c:rb-130gm-%computername%,%dhms%"
copy "c:rb-130gm-%dhms%" C:\p2\xampp\htdocs\dgnote130\documents\bklogs-rb
