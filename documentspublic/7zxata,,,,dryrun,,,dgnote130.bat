...
:only dry run..
robocopy C:\p2\xampp\htdocs\dgnote130 C:\n\Dropbox\csd\crepo\dgnote130\%computername%  /l /e /xd templates_c\ nbproject .svn /fft /xo /ndl /np /r:0 /w:0 /tee /eta /log:"c:rb-130cn-%computername%,%dhms%"
robocopy C:\p2\xampp\htdocs\dgnote130 C:\n\Dropbox\csd\crepo\dgnote130\master /l          /e  /xd templates_c\ nbproject .svn /fft /xo /ndl /np /r:0 /w:0 /tee /eta /log:"c:rb-130m-%computername%,%dhms%"
copy "c:rb-130m-%dhms%" C:\p2\xampp\htdocs\dgnote130\documents\bklogs-rb

:only my files... exclude xataface and modules
:C:\p\1ziptar\7-Zip\7z.exe a -y -t7z  -xr!templates_c -xr!nbproject "c:\backup\dgnote130\dgnote130.xata.%dhms%.%computername%.7z" C:\p2\xampp\htdocs\dgnote130 
