...
echo ran,7zxata-dgnote130-3,%computername%,"%dhms%" >> C:\p2\xampp\htdocs\dgnote130\documents\bkuplogs\7zxata-dgnote130-runlog.%computername%.csv
...
C:\p\1ziptar\7-Zip\7z.exe a -y -t7z  -xr!templates_c   -xr!.svn  "c:\backup\dgnote130\dgnote130.xata.%dhms%.%computername%.7z" C:\p2\xampp\htdocs\dgnote130 
