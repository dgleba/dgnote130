...
echo ran,7zxata-dgnote130getmaster,%computername%,"%dhms%" >> C:\p2\xampp\htdocs\dgnote130\documents\bkuplogs\7zxata-dgnote130-runlog.%computername%.csv


:only my files... exclude xataface and modules
C:\p\1ziptar\7-Zip\7z.exe a -y -t7z  -xr!templates_c "c:\backup\dgnote130\dgnote130.xata.b4.gtmstr.%dhms%.%computername%.7z" C:\p2\xampp\htdocs\dgnote130 
copy "c:\backup\dgnote130\dgnote130.xata.b4.gtmstr.%dhms%.%computername%.7z" "C:\n\Dropbox\csd\copyof\dgnote130,tagger"

robocopy C:\p2\xampp\htdocs\dgnote130 C:\n\Dropbox\csd\crepo\dgnote130\%computername%  /e /xd templates_c\ nbproject /fft /dst /xo /ndl /np /r:0 /w:0 /tee /eta /log:"c:rb-130cn-%computername%,%dhms%"

:get master
robocopy C:\n\Dropbox\csd\crepo\dgnote130\master  C:\p2\xampp\htdocs\dgnote130 /e  /xd templates_c\ /fft /dst /xo /ndl /np /r:0 /w:0 /tee /eta /log:"c:rb-130gm-%computername%,%dhms%"
copy "c:rb-130gm-%computername%,%dhms%" C:\p2\xampp\htdocs\dgnote130\documents\bklogs-rb
